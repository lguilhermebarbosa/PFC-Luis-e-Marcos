...
# --- Constantes ---
FILE_NORMAL = "normal_baseline_dataset.npz"
FILE_DADOS = "dados_baseline_dataset.npz"
FILE_JAMMER = "jammer_baseline_dataset.npz"

MODEL_FILENAME = "jammer_cnn_model.h5"
SCALER_FILENAME = "spectrum_scaler.pkl"

FFT_SIZE = 4096 # DEVE ser o mesmo FFT_SIZE dos datasets
NUM_CLASSES = 3
...
def preprocess_data(X, y):
    ...
    # Formatar para [amostras, bins_fft, 1] (1 canal)
